import { View, Text, StyleSheet, ScrollView, TouchableOpacity, ListRenderItem, Image, SectionList } from 'react-native'
      ...
      <ParallaxScrollView
        ...
        {/* <View style={styles.footer}>
            <SafeAreaView edges={['bottom']} style={{ backgroundColor: '#fff' }}>
                <Link href="/basket" asChild>
                <TouchableOpacity style={styles.fullButton}>
                    <Text style={styles.basket}>2</Text>
                    <Text style={styles.footerText}>View Basket</Text>
                    <Text style={styles.basketTotal}>LSL 1500</Text>
                </TouchableOpacity>
                </Link>
            </SafeAreaView>
        </View> */}
